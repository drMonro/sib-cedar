...
//                $test = 'dsa';
//
//        $this->ControllerProductProduct->console_log($test);
...
//                        }
            ...
            if ($data['price']) {
                if(VERSION < '2.2.0.0'){
                    $json['new_price']['price'] = $this->currency->format($this->tax->calculate((( $options_makeup) * $quantity), $product_info['tax_class_id'], $this->config->get('config_tax')));
                }else{
                    $json['new_price']['price'] = $this->currency->format($this->tax->calculate((($options_makeup) * $quantity), $product_info['tax_class_id'], $this->config->get('config_tax')), $this->session->data['currency']);
                }
            } else {
